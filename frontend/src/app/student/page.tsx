            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="card">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <a href="/student/ai-tutor" className="p-4 bg-student-primary/5 rounded-lg hover:bg-student-primary/10 transition-colors text-center group">
                        ...
                        <a href="/student/quizzes" className="p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors text-center group">
                        ...
                        <a href="/student/assignments" className="p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors text-center group">
                        ...
                        <a href="/student/weak-topics" className="p-4 bg-red-50 rounded-lg hover:bg-red-100 transition-colors text-center group">
